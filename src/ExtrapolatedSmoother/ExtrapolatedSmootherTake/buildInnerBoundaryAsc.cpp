...
void ExtrapolatedSmootherTake::nodeBuildInteriorBoundarySolverMatrix(
...
ExtrapolatedSmootherTake::MatrixType ExtrapolatedSmootherTake::buildInteriorBoundarySolverMatrix()
{
    const int i_r    = 0;
