...
void ExtrapolatedSmoother::initializeMumps(DMUMPS_STRUC_C& Asc_mumps, const SparseMatrix<double>& Asc_matrix){
...
void ExtrapolatedSmoother::deleteMumps(DMUMPS_STRUC_C& Asc_mumps){
