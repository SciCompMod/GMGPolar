...
const Stencil& ExtrapolatedSmootherTakeCPU::getStencil(int i_r, int i_theta) const
{
...
int ExtrapolatedSmootherTakeCPU::getNonZeroCountCircleAsc(const int i_r) const
{
...
int ExtrapolatedSmootherTakeCPU::getCircleAscIndex(const int i_r, const int i_theta) const
{
    assert(i_r >= 0 && i_r < grid_.numberSmootherCircles());
...
int ExtrapolatedSmootherTakeCPU::getNonZeroCountRadialAsc(const int i_theta) const
{
    throw std::out_of_range("ExtrapolatedSmoother: nnz_radial_Asc not implemented.");
}

int ExtrapolatedSmootherTakeCPU::getRadialAscIndex(const int i_r, const int i_theta) const
{
