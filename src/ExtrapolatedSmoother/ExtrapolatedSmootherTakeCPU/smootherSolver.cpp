...
void ExtrapolatedSmootherTakeCPU::applyAscOrthoCircleSection(const int i_r, const SmootherColor smoother_color,
...
void ExtrapolatedSmootherTakeCPU::applyAscOrthoRadialSection(const int i_theta, const SmootherColor smoother_color,
                                                          const Vector<double>& x, const Vector<double>& rhs,
                                                          Vector<double>& temp)
{
...
void ExtrapolatedSmootherTakeCPU::solveCircleSection(const int i_r, Vector<double>& x, Vector<double>& temp,
...
void ExtrapolatedSmootherTakeCPU::solveRadialSection(const int i_theta, Vector<double>& x, Vector<double>& temp,
...
void ExtrapolatedSmootherTakeCPU::extrapolatedSmoothingInPlace(Vector<double>& x, const Vector<double>& rhs,
                                                            Vector<double>& temp)
{
