...
void ExtrapolatedSmootherTakeCPU::buildAscCircleSection(const int i_r)
{
...
void ExtrapolatedSmootherTakeCPU::buildAscRadialSection(const int i_theta)
{
    const auto& arr        = level_cache_.arr();
    const auto& att        = level_cache_.att();
    const auto& art        = level_cache_.art();
...
void ExtrapolatedSmootherTakeCPU::buildAscMatrices()
{
    /* -------------------------------------- */
