...
void ExtrapolatedSmootherTakeCPU::initializeMumpsSolver(DMUMPS_STRUC_C& mumps_solver,
...
void ExtrapolatedSmootherTakeCPU::finalizeMumpsSolver(DMUMPS_STRUC_C& mumps_solver)
{
