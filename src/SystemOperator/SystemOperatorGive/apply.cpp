...
void SystemOperatorGive::applyCircleSection(const int i_r, Vector<double>& result, const Vector<double>& x) const
{
...
void SystemOperatorGive::applyRadialSection(const int i_theta, Vector<double>& result, const Vector<double>& x) const
{
    const double theta = grid_.theta(i_theta);
