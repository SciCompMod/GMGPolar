...
static inline void fineNodeExtrapolatedProlongation(const int i_r, const int i_theta, const PolarGrid& coarse_grid,
                                                  ...
                                                  Vector<double> fine_result, ConstVector<double> coarse_values) const
{
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const int i_r, const int i_theta) {
            fineNodeExtrapolatedProlongation(i_r, i_theta, *coarse_grid_ptr, *fine_grid_ptr, fine_result,
                                             coarse_values);
        });
