            ...
            if (i_r & 1) {                                                                                             \
                if (i_theta & 1) {                                                                                     \
                    ...
                    double outer_left_value =                                                                          \
                        (w_theta0 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse - 1, i_theta_coarse - 1)] + /* (-3, -3) */     \
                         w_theta1 * coarse_values[coarse_grid.index(i_r_coarse - 1, i_theta_coarse)] + /* (-3, -1) */  \
                         w_theta2 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse - 1, i_theta_coarse + 1)] + /* (-3, +1) */     \
                         w_theta3 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse - 1, i_theta_coarse + 2)] /* (-3, +3) */       \
                        );                                                                                             \
                    ...
                    double inner_right_value =                                                                         \
                        (w_theta0 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 1, i_theta_coarse - 1)] + /* (+1, -3) */     \
                         w_theta1 * coarse_values[coarse_grid.index(i_r_coarse + 1, i_theta_coarse)] + /* (+1, -1) */  \
                         w_theta2 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 1, i_theta_coarse + 1)] + /* (+1, +1) */     \
                         w_theta3 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 1, i_theta_coarse + 2)] /* (+1, +3) */       \
                        );                                                                                             \
                    double outer_right_value =                                                                         \
                        (w_theta0 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 2, i_theta_coarse - 1)] + /* (+3, -3) */     \
                         w_theta1 * coarse_values[coarse_grid.index(i_r_coarse + 2, i_theta_coarse)] + /* (+3, -1) */  \
                         w_theta2 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 2, i_theta_coarse + 1)] + /* (+3, +1) */     \
                         w_theta3 *                                                                                    \
                             coarse_values[coarse_grid.index(i_r_coarse + 2, i_theta_coarse + 2)] /* (+3, +3) */       \
                        );                                                                                             \
                                                                                                                       \
                    ...
                    double w_r3 = -(h0 + h1) / (h0 + h1 + h2 + h3) * h1 / (h1 + h2 + h3) * h2 / h3;                    \
                                                                                                                       \
                    fine_result[fine_grid.index(i_r, i_theta)] =                                                       \
                        (w_r0 * outer_left_value + w_r1 * inner_left_value + w_r2 * inner_right_value +                \
