...
static KOKKOS_INLINE_FUNCTION void coarseNodeRestriction(const int i_r_coarse, const int i_theta_coarse,
                                                         const PolarGrid<Kokkos::HostSpace>& fine_grid, const PolarGrid<Kokkos::HostSpace>& coarse_grid,
...
void Interpolation::applyRestriction(const PolarGrid<Kokkos::HostSpace>& fine_grid, const PolarGrid<Kokkos::HostSpace>& coarse_grid,
                                     HostVector<double> coarse_result, HostConstVector<double> fine_values) const
{
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const int i_r_coarse, const int i_theta_coarse) {
            coarseNodeRestriction(i_r_coarse, i_theta_coarse, fine_grid, coarse_grid, coarse_result, fine_values);
        });
