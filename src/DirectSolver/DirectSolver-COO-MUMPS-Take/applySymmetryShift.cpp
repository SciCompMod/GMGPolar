...
void DirectSolverTake::applySymmetryShiftInnerBoundary(Vector<double> const x) const
{
...
void DirectSolverTake::applySymmetryShiftOuterBoundary(Vector<double> const x) const
{
    assert(level_cache_.cacheDensityProfileCoefficients());
    assert(level_cache_.cacheDomainGeometry());
...
void DirectSolverTake::applySymmetryShift(Vector<double> const x) const
{
