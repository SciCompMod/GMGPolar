...
int main(int argc, char* argv[])
{
    ...
    bool PCG                            = parser.PCG();
    int PCG_FMG_iterations              = parser.PCG_FMG_iterations();
    MultigridCycleType PCG_FMG_cycle    = parser.PCG_FMG_cycle();
    ExtrapolationType PCG_extrapolation = parser.PCG_extrapolation();
    ...
    if (!PCG) {
        ...
        solver.solvePCG(parser.boundaryConditions(), parser.sourceTerm(), PCG_FMG_iterations, PCG_FMG_cycle,
                        PCG_extrapolation);
    }
