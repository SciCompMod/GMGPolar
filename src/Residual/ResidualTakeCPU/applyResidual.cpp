...
void ResidualTakeCPU::applyCircleSection(const int i_r, Vector<double>& result, const Vector<double>& rhs,
...
void ResidualTakeCPU::applyRadialSection(const int i_theta, Vector<double>& result, const Vector<double>& rhs,
                                      const Vector<double>& x) const
{
    const auto& arr        = level_cache_.arr();
    const auto& att        = level_cache_.att();
...
/* ------------------ */
/* result = rhs - A*x */
void ResidualTakeCPU::computeResidual(Vector<double>& result, const Vector<double>& rhs, const Vector<double>& x) const
{
