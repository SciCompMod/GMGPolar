...
/*........................................*/
void CartesianR6PoissonTriangular::x(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
...
/*........................................*/
void CartesianR6PoissonTriangular::x(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::y(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::y(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_rr(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_rr(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_rt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_rt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_tr(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_tr(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_tt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_tt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_xs(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_xs(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_xt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_xt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_ys(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_ys(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_yt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::J_yt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void CartesianR6PoissonTriangular::rho_glob(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::rho_glob(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::rho_pole(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::rho_pole(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::coeffs1(std::vector<double> const& r, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::coeffs2(std::vector<double> const& r, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void CartesianR6PoissonTriangular::phi_exact(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.4096 * pow(((r[i]/Rmax) - 1.0), 6.0) * pow(((r[i]/Rmax) + 1.0), 6.0) * sin(2.0 * M_PI * map2_e * (r[i]/Rmax) * sin(theta) / (sqrt(1.0 - 1.0 / 4.0 * (map2_epsilon * map2_epsilon)) * (2.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r[i]/Rmax) * cos(theta)) + 1.0)))) * cos(2.0 * M_PI * (1.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r[i]/Rmax) * cos(theta)) + 1.0)) / map2_epsilon);
    }
}
/*........................................*/
void CartesianR6PoissonTriangular::phi_exact(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.4096 * pow(((r/Rmax) - 1.0), 6.0) * pow(((r/Rmax) + 1.0), 6.0) * sin(2.0 * M_PI * map2_e * (r/Rmax) * sin_theta[i] / (sqrt(1.0 - 1.0 / 4.0 * (map2_epsilon * map2_epsilon)) * (2.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos_theta[i]) + 1.0)))) * cos(2.0 * M_PI * (1.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos_theta[i]) + 1.0)) / map2_epsilon);
    }
}
/*........................................*/
