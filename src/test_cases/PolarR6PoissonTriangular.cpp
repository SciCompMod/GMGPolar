...
/*........................................*/
double PolarR6PoissonTriangular::x(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return (1.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0)) / map2_epsilon;
}
/*........................................*/
void PolarR6PoissonTriangular::x(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::x(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::y(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::y(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::y(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_rr(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return ((-cos(theta)) / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0))/Rmax;
}
/*........................................*/
void PolarR6PoissonTriangular::J_rr(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_rr(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_rt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return (r/Rmax) * sin(theta) / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0);
}
/*........................................*/
void PolarR6PoissonTriangular::J_rt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_rt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_tr(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_tr(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_tr(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_tt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_tt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_tt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_xs(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_xs(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_xs(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_xt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_xt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_xt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_ys(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_ys(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_ys(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::J_yt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
/*........................................*/
void PolarR6PoissonTriangular::J_yt(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::J_yt(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
double PolarR6PoissonTriangular::rho_glob(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return 0.0;
}
/*........................................*/
void PolarR6PoissonTriangular::rho_glob(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void PolarR6PoissonTriangular::rho_glob(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
double PolarR6PoissonTriangular::rho_pole(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return 0.0;
}
/*........................................*/
void PolarR6PoissonTriangular::rho_pole(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
void PolarR6PoissonTriangular::rho_pole(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
double PolarR6PoissonTriangular::coeffs1(double r, double Rmax) const
{
    return 0.0;
}
/*........................................*/
void PolarR6PoissonTriangular::coeffs1(std::vector<double> const& r, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
double PolarR6PoissonTriangular::coeffs2(double r, double Rmax) const
{
    return 0.0;
}
/*........................................*/
void PolarR6PoissonTriangular::coeffs2(std::vector<double> const& r, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
        sol[i] = 0.0;
...
/*........................................*/
double PolarR6PoissonTriangular::phi_exact(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return 0.4096 * pow((r/Rmax), 6.0) * pow(((r/Rmax) - 1.0), 6.0) * cos(11.0 * theta);
}
/*........................................*/
void PolarR6PoissonTriangular::phi_exact(std::vector<double> const& r, double theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
...
/*........................................*/
void PolarR6PoissonTriangular::phi_exact(double r, std::vector<double> const& theta, double map2_epsilon, double map2_e, double Rmax, std::vector<double>& sol, std::vector<double>& sin_theta, std::vector<double>& cos_theta) const
{
    for (std::size_t i=0; i < sol.size(); ++i)
    {
