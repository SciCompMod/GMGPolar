...
PolarR6_Poisson_ShafranovGeometry::PolarR6_Poisson_ShafranovGeometry(double Rmax, double elongation_kappa,
                                                                     double shift_delta)
    : Rmax(Rmax)
...
double PolarR6_Poisson_ShafranovGeometry::rhs_f(double r, double theta)const
{
