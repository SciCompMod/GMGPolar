...
PolarR6_Poisson_CircularGeometry::PolarR6_Poisson_CircularGeometry(double Rmax)
    : Rmax(Rmax)
{
}

double PolarR6_Poisson_CircularGeometry::operator()(double r, double theta) const
{
