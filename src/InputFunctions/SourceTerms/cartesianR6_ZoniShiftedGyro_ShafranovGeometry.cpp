...
CartesianR6_ZoniShiftedGyro_ShafranovGeometry::CartesianR6_ZoniShiftedGyro_ShafranovGeometry(PolarGrid const& grid,
                                                                                             double Rmax,
...
KOKKOS_FUNCTION double CartesianR6_ZoniShiftedGyro_ShafranovGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
