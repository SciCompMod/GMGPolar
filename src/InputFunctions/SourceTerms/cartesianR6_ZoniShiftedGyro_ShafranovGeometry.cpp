...
CartesianR6_ZoniShiftedGyro_ShafranovGeometry::CartesianR6_ZoniShiftedGyro_ShafranovGeometry(
...
double CartesianR6_ZoniShiftedGyro_ShafranovGeometry::rhs_f(const double& r, const double& theta) const
{
