...
CartesianR2_Poisson_CzarnyGeometry::CartesianR2_Poisson_CzarnyGeometry(const double& Rmax,
...
double CartesianR2_Poisson_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
