...
CartesianR2_ZoniShiftedGyro_CircularGeometry::CartesianR2_ZoniShiftedGyro_CircularGeometry(const double& Rmax)
    : Rmax(Rmax)
{
}

double CartesianR2_ZoniShiftedGyro_CircularGeometry::rhs_f(const double& r, const double& theta,
