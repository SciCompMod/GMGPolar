...
CartesianR6_Zoni_CzarnyGeometry::CartesianR6_Zoni_CzarnyGeometry(const double& Rmax,
...
double CartesianR6_Zoni_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
