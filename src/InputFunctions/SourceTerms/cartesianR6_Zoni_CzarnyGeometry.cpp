...
void CartesianR6_Zoni_CzarnyGeometry::initializeGeometry()
{
    factor_xi = 1.0 / sqrt(1.0 - inverse_aspect_ratio_epsilon * inverse_aspect_ratio_epsilon / 4.0);
}

CartesianR6_Zoni_CzarnyGeometry::CartesianR6_Zoni_CzarnyGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double CartesianR6_Zoni_CzarnyGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
