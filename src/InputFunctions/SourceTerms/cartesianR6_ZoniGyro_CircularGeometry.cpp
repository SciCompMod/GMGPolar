...
CartesianR6_ZoniGyro_CircularGeometry::CartesianR6_ZoniGyro_CircularGeometry(PolarGrid<Kokkos::HostSpace> const& grid, double Rmax)
    : grid_(grid)
    , Rmax(Rmax)
{
}

KOKKOS_FUNCTION double CartesianR6_ZoniGyro_CircularGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
