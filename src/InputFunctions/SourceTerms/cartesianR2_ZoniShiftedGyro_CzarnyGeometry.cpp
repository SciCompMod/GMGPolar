...
void CartesianR2_ZoniShiftedGyro_CzarnyGeometry::initializeGeometry()
{
...
KOKKOS_FUNCTION double CartesianR2_ZoniShiftedGyro_CzarnyGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
