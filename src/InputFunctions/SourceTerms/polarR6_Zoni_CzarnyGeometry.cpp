...
PolarR6_Zoni_CzarnyGeometry::PolarR6_Zoni_CzarnyGeometry(PolarGrid const& grid, double Rmax, double inverse_aspect_ratio_epsilon,
...
double PolarR6_Zoni_CzarnyGeometry::operator()(double r, double theta) const
{
