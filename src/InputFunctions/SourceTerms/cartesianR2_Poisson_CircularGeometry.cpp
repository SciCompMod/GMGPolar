...
CartesianR2_Poisson_CircularGeometry::CartesianR2_Poisson_CircularGeometry(double Rmax)
    : Rmax(Rmax)
{
}

double CartesianR2_Poisson_CircularGeometry::operator()(double r, double theta) const
{
