...
CartesianR6_Poisson_CzarnyGeometry::CartesianR6_Poisson_CzarnyGeometry(const double& Rmax,
...
double CartesianR6_Poisson_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
