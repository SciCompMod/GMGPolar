...
CartesianR2_ZoniShifted_CircularGeometry::CartesianR2_ZoniShifted_CircularGeometry(double Rmax)
    : Rmax(Rmax)
{
}

double CartesianR2_ZoniShifted_CircularGeometry::operator()(double r, double theta) const
{
