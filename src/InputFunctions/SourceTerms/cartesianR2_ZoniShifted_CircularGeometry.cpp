...
CartesianR2_ZoniShifted_CircularGeometry::CartesianR2_ZoniShifted_CircularGeometry(PolarGrid<Kokkos::HostSpace> const& grid, double Rmax)
    : grid_(grid)
    , Rmax(Rmax)
{
}

KOKKOS_FUNCTION double CartesianR2_ZoniShifted_CircularGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
