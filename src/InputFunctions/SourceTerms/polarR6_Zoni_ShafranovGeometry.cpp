...
PolarR6_Zoni_ShafranovGeometry::PolarR6_Zoni_ShafranovGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double PolarR6_Zoni_ShafranovGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
