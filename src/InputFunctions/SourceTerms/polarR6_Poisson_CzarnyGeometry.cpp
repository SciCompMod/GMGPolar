...
PolarR6_Poisson_CzarnyGeometry::PolarR6_Poisson_CzarnyGeometry(const double& Rmax,
...
double PolarR6_Poisson_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
