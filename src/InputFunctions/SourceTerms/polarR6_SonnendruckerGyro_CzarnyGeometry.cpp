...
PolarR6_SonnendruckerGyro_CzarnyGeometry::PolarR6_SonnendruckerGyro_CzarnyGeometry(PolarGrid<Kokkos::HostSpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double PolarR6_SonnendruckerGyro_CzarnyGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
