...
CartesianR6_ZoniShifted_CzarnyGeometry::CartesianR6_ZoniShifted_CzarnyGeometry(PolarGrid const& grid, double Rmax,
...
double CartesianR6_ZoniShifted_CzarnyGeometry::operator()(double r, double theta) const
{
