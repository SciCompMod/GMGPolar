...
PolarR6_ZoniGyro_CzarnyGeometry::PolarR6_ZoniGyro_CzarnyGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double PolarR6_ZoniGyro_CzarnyGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
