...
PolarR6_ZoniGyro_CzarnyGeometry::PolarR6_ZoniGyro_CzarnyGeometry(PolarGrid const& grid, double Rmax, double inverse_aspect_ratio_epsilon,
...
double PolarR6_ZoniGyro_CzarnyGeometry::operator()(int i_r, int i_theta) const
{
