...
PolarR6_ZoniGyro_CzarnyGeometry::PolarR6_ZoniGyro_CzarnyGeometry(const double& Rmax,
...
double PolarR6_ZoniGyro_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
