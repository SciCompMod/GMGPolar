...
PolarR6_Zoni_CircularGeometry::PolarR6_Zoni_CircularGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax)
    : grid_(grid)
    , Rmax(Rmax)
{
}

KOKKOS_FUNCTION double PolarR6_Zoni_CircularGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
