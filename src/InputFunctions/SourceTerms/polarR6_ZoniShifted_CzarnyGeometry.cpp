...
PolarR6_ZoniShifted_CzarnyGeometry::PolarR6_ZoniShifted_CzarnyGeometry(const double& Rmax,
...
double PolarR6_ZoniShifted_CzarnyGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
