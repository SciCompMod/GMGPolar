...
CartesianR2_Zoni_CzarnyGeometry::CartesianR2_Zoni_CzarnyGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double CartesianR2_Zoni_CzarnyGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
