...
CartesianR2_Zoni_CzarnyGeometry::CartesianR2_Zoni_CzarnyGeometry(double Rmax, double inverse_aspect_ratio_epsilon,
...
double CartesianR2_Zoni_CzarnyGeometry::operator()(double r, double theta) const
{
