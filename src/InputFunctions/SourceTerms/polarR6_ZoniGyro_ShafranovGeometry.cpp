...
PolarR6_ZoniGyro_ShafranovGeometry::PolarR6_ZoniGyro_ShafranovGeometry(const double& Rmax,
...
double PolarR6_ZoniGyro_ShafranovGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
