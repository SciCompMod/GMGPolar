...
PolarR6_ZoniGyro_ShafranovGeometry::PolarR6_ZoniGyro_ShafranovGeometry(PolarGrid const& grid, double Rmax, double elongation_kappa,
                                                                       double shift_delta)
...
double PolarR6_ZoniGyro_ShafranovGeometry::operator()(int i_r, int i_theta) const
{
