...
CartesianR2_Poisson_ShafranovGeometry::CartesianR2_Poisson_ShafranovGeometry(PolarGrid<Kokkos::HostSpace> const& grid, double Rmax,
...
KOKKOS_FUNCTION double CartesianR2_Poisson_ShafranovGeometry::operator()(std::size_t i_r, std::size_t i_theta) const
{
