...
CartesianR6_Zoni_ShafranovGeometry::CartesianR6_Zoni_ShafranovGeometry(const double& Rmax,
...
double CartesianR6_Zoni_ShafranovGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
