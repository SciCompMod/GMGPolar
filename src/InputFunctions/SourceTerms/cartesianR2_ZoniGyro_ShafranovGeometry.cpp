...
CartesianR2_ZoniGyro_ShafranovGeometry::CartesianR2_ZoniGyro_ShafranovGeometry(double Rmax, double elongation_kappa,
                                                                               double shift_delta)
    : Rmax(Rmax)
...
double CartesianR2_ZoniGyro_ShafranovGeometry::operator()(double r, double theta) const
{
