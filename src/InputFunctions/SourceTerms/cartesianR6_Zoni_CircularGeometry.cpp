...
CartesianR6_Zoni_CircularGeometry::CartesianR6_Zoni_CircularGeometry(const double& Rmax)
    : Rmax(Rmax)
{
}

double CartesianR6_Zoni_CircularGeometry::rhs_f(const double& r, const double& theta, const double& sin_theta,
