...
CartesianR6_ZoniShiftedGyro_CircularGeometry::CartesianR6_ZoniShiftedGyro_CircularGeometry(double Rmax)
    : Rmax(Rmax)
{
}

double CartesianR6_ZoniShiftedGyro_CircularGeometry::operator()(double r, double theta) const
{
