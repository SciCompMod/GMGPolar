...
Fx_Functor::Fx_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}
Fy_Functor::Fy_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}
dFx_dr_Functor::dFx_dr_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}
dFy_dr_Functor::dFy_dr_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}
dFx_dt_Functor::dFx_dt_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}
dFy_dt_Functor::dFy_dt_Functor(std::shared_ptr<TransformationHelper> helper) : helper_(std::move(helper)) {}

// -------------------------------------- //
// Circular, Shafranov, Czarny/Triangular //
// -------------------------------------- //
