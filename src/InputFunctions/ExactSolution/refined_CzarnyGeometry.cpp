...
Refined_CzarnyGeometry::Refined_CzarnyGeometry(double Rmax, double inverse_aspect_ratio_epsilon, double ellipticity_e)
    : Rmax(Rmax)
...
double Refined_CzarnyGeometry::exact_solution(double r, double theta) const
{
