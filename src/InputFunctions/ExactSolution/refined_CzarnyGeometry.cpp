...
Refined_CzarnyGeometry::Refined_CzarnyGeometry(const double& Rmax, const double& inverse_aspect_ratio_epsilon,
...
double Refined_CzarnyGeometry::exact_solution(const double& r, const double& theta, const double& sin_theta,
