...
Refined_ShafranovGeometry::Refined_ShafranovGeometry(const double& Rmax, const double& elongation_kappa,
...
double Refined_ShafranovGeometry::exact_solution(const double& r, const double& theta, const double& sin_theta,
