...
Refined_ShafranovGeometry::Refined_ShafranovGeometry(double Rmax, double elongation_kappa,
                                                     double shift_delta)
    : Rmax(Rmax)
...
double Refined_ShafranovGeometry::exact_solution(double r, double theta)const
{
