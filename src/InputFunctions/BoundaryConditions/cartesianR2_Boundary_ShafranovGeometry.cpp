...
double CartesianR2_Boundary_ShafranovGeometry::u_D(const double& r, const double& theta, const double& sin_theta,
...
double CartesianR2_Boundary_ShafranovGeometry::u_D_Interior(const double& r, const double& theta,
