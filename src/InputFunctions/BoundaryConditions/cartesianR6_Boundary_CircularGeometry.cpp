...
double CartesianR6_Boundary_CircularGeometry::u_D(const double& r, const double& theta, const double& sin_theta,
...
double CartesianR6_Boundary_CircularGeometry::u_D_Interior(const double& r, const double& theta,
