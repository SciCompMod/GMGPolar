...
double Refined_Boundary_CircularGeometry::u_D(const double& r, const double& theta, const double& sin_theta,
...
double Refined_Boundary_CircularGeometry::u_D_Interior(const double& r, const double& theta, const double& sin_theta,
                                                       const double& cos_theta) const
{
    return ((-3.33823779536505e-15) * ((r / Rmax) * (r / Rmax)) - 0.0 * (r / Rmax) - 0.0 +
            exp((-3333.33333333333) * pow(((r / Rmax) - 0.9), 2.0))) *
