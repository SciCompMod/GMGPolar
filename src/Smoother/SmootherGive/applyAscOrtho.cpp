...
void SmootherGive::applyAscOrthoBlackCircleSection(ConstVector<double> x, ConstVector<double> rhs, Vector<double> temp)
{
...
void SmootherGive::applyAscOrthoWhiteCircleSection(ConstVector<double> x, ConstVector<double> rhs, Vector<double> temp)
{
    const int num_smoother_circles     = grid_.numberSmootherCircles();
...
void SmootherGive::applyAscOrthoBlackRadialSection(ConstVector<double> x, ConstVector<double> rhs, Vector<double> temp)
{
...
void SmootherGive::applyAscOrthoWhiteRadialSection(ConstVector<double> x, ConstVector<double> rhs, Vector<double> temp)
{
    const int num_radial_lines         = grid_.ntheta();
    const SmootherColor smoother_color = SmootherColor::White;
