        ...
        if (i_r > grid.numberSmootherCircles() && i_r < grid.nr() - 2) {                                                                                                                 \
            ...
            temp[center] =                                                                                                                                                               \
                ...
                (/* "Right" is part of the radial Asc smoother matrices, */                                                                                                              \
                     /* but is shifted over to the rhs to make the radial Asc smoother matrices symmetric. */ /* Note that the circle Asc smoother matrices are symmetric by default. */ \
                     -coeff2 * (arr[center] + arr[right]) * rhs[right] /* Right */                                                                                                       \
                 - coeff3 * (att[center] + att[bottom]) * x[bottom] /* Bottom */                                                                                                         \
                 - coeff4 * (att[center] + att[top]) * x[top] /* Top */                                                                                                                  \
                                                                                                                                                                                         \
                 - 0.25 * (art[left] + art[bottom]) * x[bottom_left] /* Bottom Left */                                                                                                   \
...
void SmootherTakeCPU::applyAscOrthoCircleSection(const int i_r, const SmootherColor smoother_color,
...
void SmootherTakeCPU::applyAscOrthoRadialSection(const int i_theta, const SmootherColor smoother_color,
                                              const Vector<double>& x, const Vector<double>& rhs, Vector<double>& temp)
{
...
void SmootherTakeCPU::solveCircleSection(const int i_r, Vector<double>& x, Vector<double>& temp,
...
void SmootherTakeCPU::solveRadialSection(const int i_theta, Vector<double>& x, Vector<double>& temp,
...
void SmootherTakeCPU::smoothingInPlace(Vector<double>& x, const Vector<double>& rhs, Vector<double>& temp)
{
