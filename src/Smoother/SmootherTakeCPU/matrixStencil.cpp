...
const Stencil& SmootherTakeCPU::getStencil(int i_r) const
{
...
int SmootherTakeCPU::getNonZeroCountCircleAsc(const int i_r) const
{
...
int SmootherTakeCPU::getCircleAscIndex(const int i_r, const int i_theta) const
{
    assert(i_r >= 0 && i_r < grid_.numberSmootherCircles());
...
int SmootherTakeCPU::getNonZeroCountRadialAsc(const int i_theta) const
{
...
int SmootherTakeCPU::getRadialAscIndex(const int i_r, const int i_theta) const
{
    assert(i_theta >= 0 && i_theta < grid_.ntheta());
