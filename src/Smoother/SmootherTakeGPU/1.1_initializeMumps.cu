...
void SmootherTakeGPU::initializeMumps(){
    ...
    inner_boundary_mumps_solver_.nz  = DirBC_Interior_ ? level_.grid().ntheta() : 4 * level_.grid().ntheta();
...
void SmootherTakeGPU::finalizeMumpsSolver()
{
