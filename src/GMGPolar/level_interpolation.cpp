...
void GMGPolar::FMGInterpolation(const int current_level, Vector<double>& result, const Vector<double>& x) const
{
    assert(current_level < number_of_levels_ && 1 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::prolongation(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ && 1 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::restriction(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ - 1 && 0 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::injection(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ - 1 && 0 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::extrapolatedProlongation(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ && 1 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::extrapolatedRestriction(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ - 1 && 0 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
...
void GMGPolar::FMGInterpolation(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const
{
    assert(current_level < number_of_levels_ && 1 <= current_level);
    if (!interpolation_) throw std::runtime_error("Interpolation not initialized.");
