...
void GMGPolar::selectTestCase()
{
    ...
    case ProblemType::CARTESIAN_R2:
        ...
        case GeometryType::SHAFRANOV:
            ...
            boundary_conditions_ =
                std::make_unique<CartesianR2_Boundary_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
            break;
        case GeometryType::CZARNY:
    ...
    case ProblemType::CARTESIAN_R6:
        ...
        case GeometryType::SHAFRANOV:
            ...
            boundary_conditions_ =
                std::make_unique<CartesianR6_Boundary_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
            break;
        case GeometryType::CZARNY:
    ...
    case ProblemType::CARTESIAN_R2:
        ...
        case GeometryType::SHAFRANOV:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR2_Sonnendrucker_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR2_SonnendruckerGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR2_ZoniGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR2_ZoniShifted_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR2_ZoniShiftedGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
        ...
        case GeometryType::CZARNY:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR2_Sonnendrucker_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR2_SonnendruckerGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR2_ZoniShifted_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR2_ZoniShiftedGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
    ...
    case ProblemType::CARTESIAN_R6:
        ...
        case GeometryType::SHAFRANOV:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR6_Sonnendrucker_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR6_SonnendruckerGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR6_ZoniGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR6_ZoniShifted_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR6_ZoniShiftedGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
        ...
        case GeometryType::CZARNY:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR6_Sonnendrucker_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR6_SonnendruckerGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<CartesianR6_ZoniShifted_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<CartesianR6_ZoniShiftedGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
    ...
    case ProblemType::POLAR_R6:
        ...
        case GeometryType::SHAFRANOV:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ZERO:
                    source_term_ =
                        std::make_unique<PolarR6_Sonnendrucker_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<PolarR6_SonnendruckerGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<PolarR6_ZoniShiftedGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
        ...
        case GeometryType::CZARNY:
            ...
            case AlphaCoeff::SONNENDRUCKER:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<PolarR6_SonnendruckerGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<PolarR6_ZoniShiftedGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta.\n");
                }
    ...
    case ProblemType::REFINED_RADIUS:
        ...
        case GeometryType::SHAFRANOV:
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<Refined_ZoniShiftedGyro_ShafranovGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta for configuration.\n");
                }
        ...
        case GeometryType::CZARNY:
            ...
            case AlphaCoeff::ZONI_SHIFTED:
                ...
                case BetaCoeff::ALPHA_INVERSE:
                    source_term_ =
                        std::make_unique<Refined_ZoniShiftedGyro_CzarnyGeometry>(Rmax_, kappa_eps_, delta_e_);
                    break;
                default:
                    throw std::runtime_error("Invalid beta for configuration.\n");
                }
