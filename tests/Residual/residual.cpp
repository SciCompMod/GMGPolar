...
TEST(OperatorATest, applyA_DirBC_Interior)
{
    ...
    ResidualGive<DomainGeometryType> residualGive_operator(level.grid(), level.levelCache(), *coefficients,
                                                           DirBC_Interior, maxOpenMPThreads);
    ResidualTake<DomainGeometryType> residualTake_operator(level.grid(), level.levelCache(), *coefficients,
                                                           DirBC_Interior, maxOpenMPThreads);
