...
TEST(GMGPolar_MGC_Cycles, V_Cycle)
{
    ...
    EXPECT_LE(number_of_iterations, 50);
...
TEST(GMGPolar_MGC_Cycles, V_Cycle_NoExtrapolation)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 1.3;
    ...
    EXPECT_LE(number_of_iterations, 7);
    EXPECT_LE(exact_error_weighted_euclidean.value(), 2e-5);
    EXPECT_LE(exact_einfinity_error.value(), 5e-5);
}

TEST(GMGPolar_MGC_Cycles, F_Cycle_NoExtrapolation)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 1.3;
...
TEST(GMGPolar_MGC_Cycles, W_Cycle_NoExtrapolation)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 1.3;
