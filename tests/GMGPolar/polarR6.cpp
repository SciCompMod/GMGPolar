...
TEST(GMGPolar_IterationCount, PolarR6_NoFMG_17x32)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 2.0;
    ...
    EXPECT_LE(number_of_iterations, 27);
    EXPECT_LE(exact_error_weighted_euclidean.value(), 7e-5);
    EXPECT_LE(exact_einfinity_error.value(), 3e-4);
}

TEST(GMGPolar_IterationCount, PolarR6_NoFMG_33x64)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 2.0;
    ...
    EXPECT_LE(number_of_iterations, 20);
    EXPECT_LE(exact_error_weighted_euclidean.value(), 2e-6);
    EXPECT_LE(exact_einfinity_error.value(), 1e-5);
}

TEST(GMGPolar_IterationCount, PolarR6_FMG_17x32)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 2.0;
    ...
    EXPECT_LE(number_of_iterations, 18);
    EXPECT_LE(exact_error_weighted_euclidean.value(), 7e-5);
    EXPECT_LE(exact_einfinity_error.value(), 3e-4);
}

TEST(GMGPolar_IterationCount, PolarR6_FMG_33x64)
{
    /* PolarGrid */
    double R0                              = 1e-8;
    double Rmax                            = 2.0;
    ...
    EXPECT_LE(number_of_iterations, 12);
    EXPECT_LE(exact_error_weighted_euclidean.value(), 2e-6);
    EXPECT_LE(exact_einfinity_error.value(), 1e-5);
}
