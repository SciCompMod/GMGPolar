...
TEST(DirectSolverTest, directSolver_DirBC_Interior)
{
    ...
    DirectSolver_COO_MUMPS_Take<DomainGeometryType> directSolverGive_operator(level.grid(), level.levelCache(),
                                                                              DirBC_Interior, maxOpenMPThreads);
    DirectSolver_COO_MUMPS_Give<DomainGeometryType> directSolverTake_operator(level.grid(), level.levelCache(),
                                                                              DirBC_Interior, maxOpenMPThreads);
...
TEST(DirectSolverTest, directSolver_AcrossOrigin)
{
    ...
    DirectSolver_COO_MUMPS_Give<DomainGeometryType> directSolverGive_operator(level.grid(), level.levelCache(),
                                                                              DirBC_Interior, maxOpenMPThreads);
    DirectSolver_COO_MUMPS_Take<DomainGeometryType> directSolverTake_operator(level.grid(), level.levelCache(),
                                                                              DirBC_Interior, maxOpenMPThreads);
...
TEST(DirectSolverTest_CircularGeometry, SequentialDirectSolverDirBC_Interior_CircularGeometry)
{
    ...
    DirectSolver_COO_MUMPS_Give<DomainGeometryType> solver_op(level.grid(), level.levelCache(), DirBC_Interior,
                                                              maxOpenMPThreads);
...
TEST(DirectSolverTakeTest_CircularGeometry, SequentialDirectSolverDirBC_Interior_CircularGeometry)
{
    ...
    DirectSolver_COO_MUMPS_Take<DomainGeometryType> solver_op(level.grid(), level.levelCache(), DirBC_Interior,
                                                              maxOpenMPThreads);
    ResidualGive<DomainGeometryType> residual_op(level.grid(), level.levelCache(), DirBC_Interior, maxOpenMPThreads);
