...
TEST(DirectSolverTest, directSolver_DirBC_Interior)
{
    ...
    Level<decltype(domain_geometry)> level(0, std::move(grid), std::move(levelCache), ExtrapolationType::NONE, false);
    ...
    DirectSolver_COO_MUMPS_Take<decltype(domain_geometry)> directSolverGive_operator(level.grid(), level.levelCache(), domain_geometry,
                                                          *coefficients, DirBC_Interior, maxOpenMPThreads);
    DirectSolver_COO_MUMPS_Give<decltype(domain_geometry)> directSolverTake_operator(level.grid(), level.levelCache(), domain_geometry,
                                                          *coefficients, DirBC_Interior, maxOpenMPThreads);
...
TEST(DirectSolverTest, directSolver_AcrossOrigin)
{
    ...
    DirectSolver_COO_MUMPS_Give<decltype(domain_geometry)> directSolverGive_operator(level.grid(), level.levelCache(), domain_geometry,
                                                          *coefficients, DirBC_Interior, maxOpenMPThreads);
    DirectSolver_COO_MUMPS_Take<decltype(domain_geometry)> directSolverTake_operator(level.grid(), level.levelCache(), domain_geometry,
                                                          *coefficients, DirBC_Interior, maxOpenMPThreads);
...
TEST(DirectSolverTest_CircularGeometry, SequentialDirectSolverDirBC_Interior_CircularGeometry)
{
    ...
    DirectSolver_COO_MUMPS_Give<decltype(domain_geometry)> solver_op(level.grid(), level.levelCache(), domain_geometry, *coefficients,
...
TEST(DirectSolverTakeTest_CircularGeometry, SequentialDirectSolverDirBC_Interior_CircularGeometry)
{
    ...
    DirectSolver_COO_MUMPS_Take<decltype(domain_geometry)> solver_op(level.grid(), level.levelCache(), domain_geometry, *coefficients,
                                          DirBC_Interior, maxOpenMPThreads);
    ResidualGive<decltype(domain_geometry)> residual_op(level.grid(), level.levelCache(), domain_geometry, *coefficients, DirBC_Interior,
                             maxOpenMPThreads);
