...
Vector<double> generate_random_sample_data_Restriction(const PolarGrid& grid, unsigned int seed) {
...
TEST(RestrictionTest, applyRestriction) {
    ...
    Vector<double> x = generate_random_sample_data_Restriction(finest_level.grid(), seed);
