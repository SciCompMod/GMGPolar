...
namespace RestrictionTest
{
    ...
    TEST(RestrictionTest, applyRestriction)
    {
        ...
        interpolation_operator.applyRestriction(finest_level, coarse_level, result, x);
        interpolation_operator.applyRestriction(finest_level, coarse_level, gpu_result, gpu_x);
