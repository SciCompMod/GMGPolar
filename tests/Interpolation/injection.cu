...
namespace InjectionTest
{
    ...
    TEST(InjectionTest, applyInjection)
    {
        ...
        Vector<double> result(coarse_level.grid().numberOfNodes());
        GPU_Vector<double> gpu_result(coarse_level.grid().numberOfNodes());

        interpolation_operator.applyInjection(finest_level, coarse_level, result, x);
        interpolation_operator.applyInjection(finest_level, coarse_level, gpu_result, gpu_x);
