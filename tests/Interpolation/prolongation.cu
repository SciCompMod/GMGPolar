...
namespace ProlongationTest
{
    ...
    TEST(ProlongationTest, applyProlongation)
    {
        ...
        interpolation_operator.applyProlongation(coarse_level, finest_level, result, x);
        interpolation_operator.applyProlongation(coarse_level, finest_level, gpu_result, gpu_x);
