...
namespace ExtrapolatedRestrictionTest
{
    ...
    TEST(ExtrapolatedRestrictionTest, applyExtrapolatedRestriction)
    {
        ...
        interpolation_operator.applyExtrapolatedRestriction(finest_level, coarse_level, result, x);
        interpolation_operator.applyExtrapolatedRestriction(finest_level, coarse_level, gpu_result, gpu_x);
