...
TEST(ExtrapolatedRestrictionTest, applyExtrapolatedRestriction) {
    ...
    auto finest_levelCache = std::make_unique<LevelCache>(*finest_grid, *coefficients, domain_geometry, cache_density_rpofile_coefficients, cache_domain_geometry);
    auto coarse_levelCache = std::make_unique<LevelCache>(*coarse_grid, *coefficients, domain_geometry, cache_density_rpofile_coefficients, cache_domain_geometry);

    Level finest_level(0, std::move(finest_grid), std::move(finest_levelCache), ExtrapolationType::IMPLICIT_EXTRAPOLATION, 0);
    Level coarse_level(1, std::move(coarse_grid), std::move(coarse_levelCache), ExtrapolationType::IMPLICIT_EXTRAPOLATION, 0);
