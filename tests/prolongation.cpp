...
TEST(ProlongationTest, ProlongationSmoothingRadius) {
    ...
    Level toLevel(0);
    toLevel.setGrid(std::make_unique<PolarGrid>(std::move(fine_grid)));
    Level fromLevel(1);
    fromLevel.setGrid(std::move(coarse_grid));
    ...
    op->applyProlongation0(fromLevel, toLevel, result1, x);
    op->applyProlongation(fromLevel, toLevel, result2, x);
...
TEST(ProlongationTest, ProlongationRadialIndexing) {
    std::vector<double> fine_radii = {0.1, 0.2, 0.25, 0.5, 0.8, 0.9, 1.3, 1.4, 2.0};
    std::vector<double> fine_angles = {0, M_PI/16, M_PI/8, M_PI/2, M_PI, M_PI+M_PI/16, M_PI+M_PI/8, M_PI+M_PI/2, M_PI+M_PI};
...
TEST(ProlongationTest, ProlongationCircleIndexing) {
    std::vector<double> fine_radii = {0.1, 0.2, 0.25, 0.5, 0.8, 0.9, 1.3, 1.4, 2.0};
    std::vector<double> fine_angles = {0, M_PI/16, M_PI/8, M_PI/2, M_PI, M_PI+M_PI/16, M_PI+M_PI/8, M_PI+M_PI/2, M_PI+M_PI};
...
TEST(ProlongationTest, ProlongationAutomaticSmoothingRadius) {
    std::vector<double> fine_radii = {0.1, 0.2, 0.25, 0.5, 0.8, 0.9, 1.3, 1.4, 2.0};
    std::vector<double> fine_angles = {0, M_PI/16, M_PI/8, M_PI/2, M_PI, M_PI+M_PI/16, M_PI+M_PI/8, M_PI+M_PI/2, M_PI+M_PI};
