...
TEST(ExtrapolatedSmootherTest, extrapolatedSmoother_DirBC_Interior)
{
    ...
    ExtrapolatedSmootherGive<DomainGeometryType> smootherGive_operator(level.grid(), level.levelCache(), *coefficients,
                                                                       DirBC_Interior, maxOpenMPThreads);
    ExtrapolatedSmootherTake<DomainGeometryType> smootherTake_operator(level.grid(), level.levelCache(), *coefficients,
                                                                       DirBC_Interior, maxOpenMPThreads);
...
TEST(ExtrapolatedSmootherTest, SequentialExtrapolatedSmootherDirBC_Interior)
{
    ...
    DirectSolver_CSR_LU_Give<DomainGeometryType> solver_op(level.grid(), level.levelCache(), *coefficients,
                                                           DirBC_Interior, maxOpenMPThreads);
...
TEST(ExtrapolatedSmootherTest, SequentialExtrapolatedSmootherTakeDirBC_Interior)
{
    ...
    DirectSolver_CSR_LU_Take<DomainGeometryType> solver_op(level.grid(), level.levelCache(), *coefficients,
                                                           DirBC_Interior, maxOpenMPThreads);
    ResidualTake<DomainGeometryType> residual_op(level.grid(), level.levelCache(), *coefficients, DirBC_Interior,
                                                 maxOpenMPThreads);
