...
TEST(ExtrapolatedSmootherTest, SequentialExtrapolatedSmootherDirBC_Interior) {
    ...
    ExtrapolatedSmoother extrapolated_smoother_op(level.grid(), level.levelCache(), domain_geometry, DirBC_Interior, maxOpenMPThreads);
...
//     DirectSolver solver_op(level.grid(), level.levelCache(), domain_geometry, DirBC_Interior, maxOpenMPThreads);
//     Residual residual_op(level.grid(), level.levelCache(), domain_geometry, DirBC_Interior, maxOpenMPThreads);
//     ExtrapolatedExtrapolatedSmoother extrapolated_extrapolated_smoother_op(level.grid(), level.levelCache(), domain_geometry, DirBC_Interior, maxOpenMPThreads);
