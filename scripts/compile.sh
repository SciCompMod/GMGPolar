...
#     cmake -S ${PWD}/.. -B ${PWD}/../build -DCMAKE_BUILD_TYPE="$build_type" -DCMAKE_PREFIX_PATH="/home/jli/spack/opt/spack/linux-ubuntu24.04-zen4/gcc-13.3.0/mumps-5.7.3-jy2vqbushbstgmldftacxhar4eqf7ccw" .. || { echo "CMake configuration failed"; exit 1; }
# fi
