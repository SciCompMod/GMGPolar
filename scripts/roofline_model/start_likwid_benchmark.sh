...
echo "#SBATCH --partition=naples128" >> run_COMPACT_FLOPS_DP_likwid.sh
echo "#SBATCH --account=2476029" >> run_COMPACT_FLOPS_DP_likwid.sh
...
echo "#SBATCH --partition=naples128" >> run_COMPACT_MEM_DP_likwid.sh
echo "#SBATCH --account=2476029" >> run_COMPACT_MEM_DP_likwid.sh
