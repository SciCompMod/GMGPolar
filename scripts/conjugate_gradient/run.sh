...
# Set path to the PCG-GMGPolar executable
PCG_EXEC="${SCRIPT_DIR}/../../build/conjugate_gradient"
...
PCG=1 # 0: GMGPolar, 1: New MG-PCG approach
PCG_FMG_iterations=1
PCG_FMG_cycle=0 # V-Cycle(0), W-Cycle(1), F-Cycle(2)
PCG_extrapolation=0 # 0: No extrapolation, 1: Implicit extrapolation (0 is faster and still converges to high order solution)
...
"$PCG_EXEC" \
    ...
    --PCG_extrapolation $PCG_extrapolation
