...
then
  ...
  then
    ...
    then
      ...
      ../${build_dir}/gmgpolar --nr_exp 4 --anisotropic_factor 0 --geometry 3 --DirBC_Interior 1 --divideBy2 0 --R0 1e-5 --verbose 2 --extrapolation 0 --openmp 4 --preSmoothingSteps 1 --postSmoothingSteps 1 --Rmax 1.0 --problem 1 --maxIterations 300 --alpha_coeff 3 --alpha_jump 0.7 --beta_coeff 1 --residualNormType 2 --write_grid_file $write_grid_file --load_grid_file 1 --file_grid_radii "r.txt" --file_grid_angles "theta.txt" 
