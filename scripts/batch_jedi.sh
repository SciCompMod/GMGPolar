...
#SBATCH --output=slurm-maxLevel13_GMGPolar_JEDI_Rmax13_ani0_DirBC.out
#SBATCH --error=slurm-maxLevel13_GMGPolar_JEDI_Rmax13_ani0_DirBC.err
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 72
#SBATCH --gres=gpu:1
