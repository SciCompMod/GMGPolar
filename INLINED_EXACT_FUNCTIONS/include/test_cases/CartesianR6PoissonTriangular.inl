...
inline double CartesianR6PoissonTriangular::x(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return (1.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0)) / map2_epsilon;
}

inline double CartesianR6PoissonTriangular::y(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
inline double CartesianR6PoissonTriangular::J_rr(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return ((-cos(theta)) / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0))/Rmax;
}

inline double CartesianR6PoissonTriangular::J_rt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return (r/Rmax) * sin(theta) / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos(theta)) + 1.0);
}

inline double CartesianR6PoissonTriangular::J_tr(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
inline double CartesianR6PoissonTriangular::J_tt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
// inline double CartesianR6PoissonTriangular::J_xs(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
// {
...
// inline double CartesianR6PoissonTriangular::J_xt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
// {
...
// inline double CartesianR6PoissonTriangular::J_ys(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
// {
...
// inline double CartesianR6PoissonTriangular::J_yt(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
// {
...
inline double CartesianR6PoissonTriangular::rho_glob(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::rho_pole(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::coeffs1(double r, double Rmax) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::coeffs2(double r, double Rmax) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::phi_exact(double r, double theta, double map2_epsilon, double map2_e, double Rmax) const
{
...
inline double CartesianR6PoissonTriangular::x(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
    return (1.0 - sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos_theta) + 1.0)) / map2_epsilon;
}

inline double CartesianR6PoissonTriangular::y(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
...
inline double CartesianR6PoissonTriangular::J_rr(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
    return ((-cos_theta) / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos_theta) + 1.0))/Rmax;
}

inline double CartesianR6PoissonTriangular::J_rt(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * sin_theta / sqrt(map2_epsilon * (map2_epsilon + 2.0 * (r/Rmax) * cos_theta) + 1.0);
}

inline double CartesianR6PoissonTriangular::J_tr(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
...
inline double CartesianR6PoissonTriangular::J_tt(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
...
// inline double CartesianR6PoissonTriangular::J_xs(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double CartesianR6PoissonTriangular::J_xt(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double CartesianR6PoissonTriangular::J_ys(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double CartesianR6PoissonTriangular::J_yt(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
// {
...
inline double CartesianR6PoissonTriangular::rho_glob(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::rho_pole(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}

inline double CartesianR6PoissonTriangular::phi_exact(double r, double theta, double map2_epsilon, double map2_e, double Rmax, double sin_theta, double cos_theta) const
{
