...
class PolarR6GyroZoniShiftedCulham: public ExactFunctions
{
public:
...
private:
    double my_sum(std::array<double, 1001>& f, int64_t start_idx, int64_t end_idx) const; // Unused?
...
#include "PolarR6GyroZoniShiftedCulham.inl"
