...
inline double RefinedGyroZoniShiftedCulham::q(double rr) const
{
    return 0.8 - 0.1 * (rr * rr);
}

inline double RefinedGyroZoniShiftedCulham::dq(double rr) const
{
    return (-0.2) * rr;
}

inline double RefinedGyroZoniShiftedCulham::p(double rr) const
{
    return 100000.0 - 90000.0 * (rr * rr);
}

inline double RefinedGyroZoniShiftedCulham::dp(double rr) const
{
    return (-180000.0) * rr;
}

inline double RefinedGyroZoniShiftedCulham::dg(double rr, double g) const
{
...
inline double RefinedGyroZoniShiftedCulham::double_deriv(double rr, double c, double g, double dg, double val, double d_val) const
{
...
inline double RefinedGyroZoniShiftedCulham::g(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::Delta(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::Delta_prime(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::E(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::T(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::E_prime(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::T_prime(double rr) const
{
    int64_t ri;
    double dr;
    double m;
...
inline double RefinedGyroZoniShiftedCulham::x(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return (r/Rmax) * cos(theta) + Delta((r/Rmax)) - E((r/Rmax)) * cos(theta) - P((r/Rmax)) * cos(theta) + T((r/Rmax)) * cos(2.0 * theta) + 5.0;
}

inline double RefinedGyroZoniShiftedCulham::y(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return (r/Rmax) * sin(theta) - E((r/Rmax)) * sin(theta) - P((r/Rmax)) * sin(theta) - T((r/Rmax)) * sin(2.0 * theta);
}

inline double RefinedGyroZoniShiftedCulham::J_rr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return (Delta_prime((r/Rmax)) - E_prime((r/Rmax)) * cos(theta) + T_prime((r/Rmax)) * cos(2.0 * theta) - dP((r/Rmax)) * cos(theta) + cos(theta))/Rmax;
}

inline double RefinedGyroZoniShiftedCulham::J_rt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return (-(r/Rmax)) * sin(theta) + E((r/Rmax)) * sin(theta) + P((r/Rmax)) * sin(theta) - 2.0 * T((r/Rmax)) * sin(2.0 * theta);
}

inline double RefinedGyroZoniShiftedCulham::J_tr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return ((-E_prime((r/Rmax))) * sin(theta) - T_prime((r/Rmax)) * sin(2.0 * theta) - dP((r/Rmax)) * sin(theta) + sin(theta))/Rmax;
}

inline double RefinedGyroZoniShiftedCulham::J_tt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return (r/Rmax) * cos(theta) - E((r/Rmax)) * cos(theta) - P((r/Rmax)) * cos(theta) - 2.0 * T((r/Rmax)) * cos(2.0 * theta);
}

// inline double RefinedGyroZoniShiftedCulham::J_xr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_xq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_yr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_yq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
// {
//     return ((-Delta_prime((r/Rmax))) + E_prime((r/Rmax)) * cos(theta) - T_prime((r/Rmax)) * cos(2.0 * theta) + dP((r/Rmax)) * cos(theta) - cos(theta)) / ((-(r/Rmax)) * Delta_prime((r/Rmax)) * cos(theta) + (r/Rmax) * E_prime((r/Rmax)) * pow(sin(theta), 2.0) + (r/Rmax) * E_prime((r/Rmax)) * pow(cos(theta), 2.0) + (r/Rmax) * T_prime((r/Rmax)) * sin(theta) * sin(2.0 * theta) - (r/Rmax) * T_prime((r/Rmax)) * cos(theta) * cos(2.0 * theta) + (r/Rmax) * dP((r/Rmax)) * pow(sin(theta), 2.0) + (r/Rmax) * dP((r/Rmax)) * pow(cos(theta), 2.0) - (r/Rmax) * pow(sin(theta), 2.0) - (r/Rmax) * pow(cos(theta), 2.0) + Delta_prime((r/Rmax)) * E((r/Rmax)) * cos(theta) + Delta_prime((r/Rmax)) * P((r/Rmax)) * cos(theta) + 2.0 * Delta_prime((r/Rmax)) * T((r/Rmax)) * cos(2.0 * theta) - E((r/Rmax)) * E_prime((r/Rmax)) * pow(sin(theta), 2.0) - E((r/Rmax)) * E_prime((r/Rmax)) * pow(cos(theta), 2.0) - E((r/Rmax)) * T_prime((r/Rmax)) * sin(theta) * sin(2.0 * theta) + E((r/Rmax)) * T_prime((r/Rmax)) * cos(theta) * cos(2.0 * theta) - E((r/Rmax)) * dP((r/Rmax)) * pow(sin(theta), 2.0) - E((r/Rmax)) * dP((r/Rmax)) * pow(cos(theta), 2.0) + E((r/Rmax)) * pow(sin(theta), 2.0) + E((r/Rmax)) * pow(cos(theta), 2.0) - E_prime((r/Rmax)) * P((r/Rmax)) * pow(sin(theta), 2.0) - E_prime((r/Rmax)) * P((r/Rmax)) * pow(cos(theta), 2.0) + 2.0 * E_prime((r/Rmax)) * T((r/Rmax)) * sin(theta) * sin(2.0 * theta) - 2.0 * E_prime((r/Rmax)) * T((r/Rmax)) * cos(theta) * cos(2.0 * theta) - P((r/Rmax)) * T_prime((r/Rmax)) * sin(theta) * sin(2.0 * theta) + P((r/Rmax)) * T_prime((r/Rmax)) * cos(theta) * cos(2.0 * theta) - P((r/Rmax)) * dP((r/Rmax)) * pow(sin(theta), 2.0) - P((r/Rmax)) * dP((r/Rmax)) * pow(cos(theta), 2.0) + P((r/Rmax)) * pow(sin(theta), 2.0) + P((r/Rmax)) * pow(cos(theta), 2.0) + 2.0 * T((r/Rmax)) * T_prime((r/Rmax)) * pow(sin(2.0 * theta), 2.0) + 2.0 * T((r/Rmax)) * T_prime((r/Rmax)) * pow(cos(2.0 * theta), 2.0) + 2.0 * T((r/Rmax)) * dP((r/Rmax)) * sin(theta) * sin(2.0 * theta) - 2.0 * T((r/Rmax)) * dP((r/Rmax)) * cos(theta) * cos(2.0 * theta) - 2.0 * T((r/Rmax)) * sin(theta) * sin(2.0 * theta) + 2.0 * T((r/Rmax)) * cos(theta) * cos(2.0 * theta));
// }

inline double RefinedGyroZoniShiftedCulham::coeffs1(double r, double Rmax) const
...
inline double RefinedGyroZoniShiftedCulham::coeffs2(double r, double Rmax) const
{
    return 1.0 * exp(tanh(20.0 * (r/Rmax) - 14.0));
}

inline double RefinedGyroZoniShiftedCulham::rho_glob(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
...
inline double RefinedGyroZoniShiftedCulham::rho_pole(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return 0.0;
}

inline double RefinedGyroZoniShiftedCulham::phi_exact(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax) const
{
    return 0.0;
}
...
inline double RefinedGyroZoniShiftedCulham::x(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * cos_theta + Delta((r/Rmax)) - E((r/Rmax)) * cos_theta - P((r/Rmax)) * cos_theta + T((r/Rmax)) * cos(2.0 * theta) + 5.0;
}

inline double RefinedGyroZoniShiftedCulham::y(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * sin_theta - E((r/Rmax)) * sin_theta - P((r/Rmax)) * sin_theta - T((r/Rmax)) * sin(2.0 * theta);
}

inline double RefinedGyroZoniShiftedCulham::J_rr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (Delta_prime((r/Rmax)) - E_prime((r/Rmax)) * cos_theta + T_prime((r/Rmax)) * cos(2.0 * theta) - dP((r/Rmax)) * cos_theta + cos_theta)/Rmax;
}

inline double RefinedGyroZoniShiftedCulham::J_rt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (-(r/Rmax)) * sin_theta + E((r/Rmax)) * sin_theta + P((r/Rmax)) * sin_theta - 2.0 * T((r/Rmax)) * sin(2.0 * theta);
}

inline double RefinedGyroZoniShiftedCulham::J_tr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return ((-E_prime((r/Rmax))) * sin_theta - T_prime((r/Rmax)) * sin(2.0 * theta) - dP((r/Rmax)) * sin_theta + sin_theta)/Rmax;
}

inline double RefinedGyroZoniShiftedCulham::J_tt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * cos_theta - E((r/Rmax)) * cos_theta - P((r/Rmax)) * cos_theta - 2.0 * T((r/Rmax)) * cos(2.0 * theta);
}

// inline double RefinedGyroZoniShiftedCulham::J_xr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_xq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_yr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
// {
...
// inline double RefinedGyroZoniShiftedCulham::J_yq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
// {
...
inline double RefinedGyroZoniShiftedCulham::rho_glob(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return ((-3.33823779536505e-15) * ((r/Rmax) * (r/Rmax)) - 0.0 * (r/Rmax) - 0.0 + exp((-3333.33333333333) * pow(((r/Rmax) - 0.9), 2.0))) * cos(21.0 * theta) + (0.00184273372222541 * ((r/Rmax) * (r/Rmax)) - 0.0018029383826828 * (r/Rmax) - 4.00652973929511e-05 + exp((-50.0) * pow(((r/Rmax) - 0.45), 2.0))) * cos(9.0 * theta);
}

inline double RefinedGyroZoniShiftedCulham::rho_pole(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}

inline double RefinedGyroZoniShiftedCulham::phi_exact(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}
