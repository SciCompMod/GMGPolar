...
public:
    ...
    void applyProlongation(const PolarGrid& coarse_grid, const PolarGrid& fine_grid, HostVector<double> fine_result,
    ...
    void applyRestriction(const PolarGrid& fine_grid, const PolarGrid& coarse_grid, HostVector<double> coarse_result,
                          HostConstVector<double> fine_values) const;
    ...
    void applyFMGInterpolation(const PolarGrid& coarse_grid, const PolarGrid& fine_grid, HostVector<double> fine_result,
                               HostConstVector<double> coarse_values) const;
