...
void SmootherGive<DomainGeometry>::nodeBuildTridiagonalSolverMatrices(
...
template <concepts::DomainGeometry DomainGeometry>
void SmootherGive<DomainGeometry>::buildTridiagonalCircleSection(int i_r)
{
...
template <concepts::DomainGeometry DomainGeometry>
void SmootherGive<DomainGeometry>::buildTridiagonalRadialSection(int i_theta)
{
    const PolarGrid& grid                         = Smoother<DomainGeometry>::grid_;
    const LevelCache<DomainGeometry>& level_cache = Smoother<DomainGeometry>::level_cache_;
    const bool DirBC_Interior                     = Smoother<DomainGeometry>::DirBC_Interior_;
...
template <concepts::DomainGeometry DomainGeometry>
void SmootherGive<DomainGeometry>::buildTridiagonalSolverMatrices()
{
    const PolarGrid& grid                         = Smoother<DomainGeometry>::grid_;
    const LevelCache<DomainGeometry>& level_cache = Smoother<DomainGeometry>::level_cache_;
    const bool DirBC_Interior                     = Smoother<DomainGeometry>::DirBC_Interior_;
