...
void SmootherGive<LevelCacheType>::nodeBuildInteriorBoundarySolverMatrix_i_r_0(int i_theta, const PolarGrid& grid,
                                                                               bool DirBC_Interior,
...
template <class LevelCacheType>
void SmootherGive<LevelCacheType>::nodeBuildInteriorBoundarySolverMatrix_i_r_1(int i_theta, const PolarGrid& grid,
                                                                               bool DirBC_Interior,
                                                                               InnerBoundaryMatrix& matrix, double arr,
                                                                               double att, double art, double detDF,
                                                                               double coeff_beta)
