...
void SmootherTake<DomainGeometry>::initializeMumpsSolver(DMUMPS_STRUC_C& mumps_solver,
...
template <concepts::DomainGeometry DomainGeometry>
void SmootherTake<DomainGeometry>::finalizeMumpsSolver(DMUMPS_STRUC_C& mumps_solver)
{
