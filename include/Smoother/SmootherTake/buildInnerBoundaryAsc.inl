...
static KOKKOS_INLINE_FUNCTION void update_CSR_COO_MatrixElement(SparseMatrixCOO<double, Kokkos::HostSpace>& matrix,
...
static KOKKOS_INLINE_FUNCTION void update_CSR_COO_MatrixElement(SparseMatrixCSR<double, Kokkos::HostSpace>& matrix,
                                                                int ptr, int offset, int row, int column, double value)
{
