...
void DirectSolver_CSR_LU_Take<DomainGeometry>::applySymmetryShiftInnerBoundary(Vector<double> x) const
{
...
template <concepts::DomainGeometry DomainGeometry>
void DirectSolver_CSR_LU_Take<DomainGeometry>::applySymmetryShiftOuterBoundary(Vector<double> x) const
{
    const PolarGrid& grid                         = DirectSolver<DomainGeometry>::grid_;
    const LevelCache<DomainGeometry>& level_cache = DirectSolver<DomainGeometry>::level_cache_;
...
template <concepts::DomainGeometry DomainGeometry>
void DirectSolver_CSR_LU_Take<DomainGeometry>::applySymmetryShift(Vector<double> x) const
{
    const PolarGrid& grid     = DirectSolver<DomainGeometry>::grid_;
