...
DirectSolver_CSR_LU_Give<LevelCacheType>::DirectSolver_CSR_LU_Give(const PolarGrid& grid,
...
template <class LevelCacheType>
void DirectSolver_CSR_LU_Give<LevelCacheType>::solveInPlace(Vector<double> solution)
{
