...
inline double CzarnyGeometry::Fx(const double& r, const double& theta) const {
...
inline double CzarnyGeometry::Fy(const double& r, const double& theta) const {
...
inline double CzarnyGeometry::dFx_dr(const double& r, const double& theta) const {
    double cos_theta = std::cos(theta);
...
inline double CzarnyGeometry::dFy_dr(const double& r, const double& theta) const {
    double sin_theta = std::sin(theta);
    double cos_theta = std::cos(theta);
...
inline double CzarnyGeometry::dFx_dt(const double& r, const double& theta) const {
    double sin_theta = std::sin(theta);
    double cos_theta = std::cos(theta);
...
inline double CzarnyGeometry::dFy_dt(const double& r, const double& theta) const {
    double sin_theta = std::sin(theta);
    double cos_theta = std::cos(theta);
    double temp = sqrt(inverse_aspect_ratio_epsilon * (2.0 * (r/Rmax) * cos_theta + inverse_aspect_ratio_epsilon) + 1.0);
