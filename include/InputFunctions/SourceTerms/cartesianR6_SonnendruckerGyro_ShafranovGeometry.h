...
public:
    CartesianR6_SonnendruckerGyro_ShafranovGeometry() = default;
    explicit CartesianR6_SonnendruckerGyro_ShafranovGeometry(const double& Rmax, const double& elongation_kappa, const double& shift_delta);
