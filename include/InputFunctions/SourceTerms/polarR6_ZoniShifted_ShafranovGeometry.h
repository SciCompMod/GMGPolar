...
public:
    PolarR6_ZoniShifted_ShafranovGeometry() = default;
    explicit PolarR6_ZoniShifted_ShafranovGeometry(const double& Rmax, const double& elongation_kappa, const double& shift_delta);
