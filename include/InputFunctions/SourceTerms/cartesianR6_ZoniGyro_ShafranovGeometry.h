...
public:
    CartesianR6_ZoniGyro_ShafranovGeometry() = default;
    explicit CartesianR6_ZoniGyro_ShafranovGeometry(const double& Rmax, const double& elongation_kappa, const double& shift_delta);
