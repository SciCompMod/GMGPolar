...
{
public:
    explicit Refined_ZoniShiftedGyro_CzarnyGeometry(PolarGrid<DefaultMemorySpace> const& grid, double Rmax,
                                                    double inverse_aspect_ratio_epsilon, double ellipticity_e);
    KOKKOS_DEFAULTED_FUNCTION
    Refined_ZoniShiftedGyro_CzarnyGeometry(const Refined_ZoniShiftedGyro_CzarnyGeometry&) = default;
