...
public:
    PolarR6_ZoniShiftedGyro_ShafranovGeometry() = default;
    explicit PolarR6_ZoniShiftedGyro_ShafranovGeometry(const double& Rmax, const double& elongation_kappa, const double& shift_delta);
