...
public:
    CartesianR6_ZoniShiftedGyro_CzarnyGeometry() = default;
    explicit CartesianR6_ZoniShiftedGyro_CzarnyGeometry(const double& Rmax, const double& inverse_aspect_ratio_epsilon, const double& ellipticity_e);
