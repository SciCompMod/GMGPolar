...
public:
    ...
    double t_solve_initial_approximation = 0.0;
...
private:
    ...
    void extrapolatedProlongation(const int current_level, GPU_Vector<double>& result, const GPU_Vector<double>& x) const;
