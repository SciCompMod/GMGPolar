...
void GMGPolar<DomainGeometry, DensityProfileCoefficients, ExactSolution>::extrapolated_multigrid_V_Cycle(
    int level_depth, Vector<double> solution, ConstVector<double> rhs, Vector<double> residual)
{
