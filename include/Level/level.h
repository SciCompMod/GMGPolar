...
public:
    ...
    // -------------- //
    // Apply Residual //
    void initializeResidual(const bool DirBC_Interior,
    ...
    // ------------------- //
    // Solve coarse System //
    void initializeDirectSolver(const bool DirBC_Interior,
                                const int num_omp_threads, const StencilDistributionMethod stencil_distribution_method);
    ...
    // --------------- //
    // Apply Smoothing //
    void initializeSmoothing(const bool DirBC_Interior,
                             const int num_omp_threads, const StencilDistributionMethod stencil_distribution_method);
