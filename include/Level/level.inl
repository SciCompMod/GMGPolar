...
// Apply Residual //
template <concepts::DomainGeometry DomainGeometry>
void Level<DomainGeometry>::initializeResidual(const DomainGeometry& domain_geometry, const bool DirBC_Interior,
...
// Solve coarse System //
template <concepts::DomainGeometry DomainGeometry>
void Level<DomainGeometry>::initializeDirectSolver(const DomainGeometry& domain_geometry, const bool DirBC_Interior,
                                                   const int num_omp_threads,
                                                   const StencilDistributionMethod stencil_distribution_method)
{
    ...
    if (stencil_distribution_method == StencilDistributionMethod::CPU_TAKE) {
        op_directSolver_ = std::make_unique<DirectSolver_COO_MUMPS_Take<DomainGeometry>>(
            *grid_, *level_cache_, domain_geometry, DirBC_Interior, num_omp_threads);
    }
    else if (stencil_distribution_method == StencilDistributionMethod::CPU_GIVE) {
...
// Apply Smoothing //
template <concepts::DomainGeometry DomainGeometry>
void Level<DomainGeometry>::initializeSmoothing(const DomainGeometry& domain_geometry, const bool DirBC_Interior,
                                                const int num_omp_threads,
                                                const StencilDistributionMethod stencil_distribution_method)
{
    if (stencil_distribution_method == StencilDistributionMethod::CPU_TAKE) {
...
template <concepts::DomainGeometry DomainGeometry>
void Level<DomainGeometry>::initializeExtrapolatedSmoothing(const DomainGeometry& domain_geometry,
