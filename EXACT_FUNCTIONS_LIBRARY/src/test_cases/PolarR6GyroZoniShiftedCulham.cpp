...
double PolarR6GyroZoniShiftedCulham::x(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * cos_theta + Delta((r/Rmax)) - E((r/Rmax)) * cos_theta - P((r/Rmax)) * cos_theta + T((r/Rmax)) * cos(2.0 * theta) + 5.0;
}

double PolarR6GyroZoniShiftedCulham::y(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * sin_theta - E((r/Rmax)) * sin_theta - P((r/Rmax)) * sin_theta - T((r/Rmax)) * sin(2.0 * theta);
}

double PolarR6GyroZoniShiftedCulham::J_rr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (Delta_prime((r/Rmax)) - E_prime((r/Rmax)) * cos_theta + T_prime((r/Rmax)) * cos(2.0 * theta) - dP((r/Rmax)) * cos_theta + cos_theta)/Rmax;
}

double PolarR6GyroZoniShiftedCulham::J_rt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (-(r/Rmax)) * sin_theta + E((r/Rmax)) * sin_theta + P((r/Rmax)) * sin_theta - 2.0 * T((r/Rmax)) * sin(2.0 * theta);
}

double PolarR6GyroZoniShiftedCulham::J_tr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return ((-E_prime((r/Rmax))) * sin_theta - T_prime((r/Rmax)) * sin(2.0 * theta) - dP((r/Rmax)) * sin_theta + sin_theta)/Rmax;
}

double PolarR6GyroZoniShiftedCulham::J_tt(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return (r/Rmax) * cos_theta - E((r/Rmax)) * cos_theta - P((r/Rmax)) * cos_theta - 2.0 * T((r/Rmax)) * cos(2.0 * theta);
}

double PolarR6GyroZoniShiftedCulham::J_xr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
...
double PolarR6GyroZoniShiftedCulham::J_xq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
...
double PolarR6GyroZoniShiftedCulham::J_yr(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
...
double PolarR6GyroZoniShiftedCulham::J_yq(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
...
double PolarR6GyroZoniShiftedCulham::rho_glob(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.4096 * pow((r/Rmax), 6.0) * pow(((r/Rmax) - 1.0), 6.0) * cos(11.0 * theta);
}

double PolarR6GyroZoniShiftedCulham::rho_pole(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}

double PolarR6GyroZoniShiftedCulham::phi_exact(double r, double theta, double map3_unused_1, double map3_unused_2, double Rmax, double sin_theta, double cos_theta) const
{
    return 0.0;
}
