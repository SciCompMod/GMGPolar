...
//         coeff_alpha = density_profile_coefficients_.alpha(coords[0]);
//         coeff_beta = density_profile_coefficients_.beta(coords[0]);
...
//                 double coeff_alpha_left = density_profile_coefficients_.alpha(left_coords[0]);
...
//                 double coeff_alpha_left = density_profile_coefficients_.alpha(across_origin_coords[0]);
...
//                 double coeff_alpha_right = density_profile_coefficients_.alpha(right_coords[0]);
...
//                 double coeff_alpha_bottom = density_profile_coefficients_.alpha(bottom_coords[0]);
...
//                 double coeff_alpha_top = density_profile_coefficients_.alpha(top_coords[0]);
